...
@Controller
@RequestMapping("/congan-panel")
public class PoliceLoginController {

    @RequestMapping(method = RequestMethod.GET)
    public String index() {
        return "redirect:/congan-panel/login";
    }
            ...
            ModelMap modelMap)
    {
        ...
        modelMap.put("formLogin", "Công An Login");
    ...
    public String logout(HttpSession httpSession) {
        ...
        return "redirect:/congan-panel/login?logout";
    }

    @RequestMapping(value = "accessDenied", method = RequestMethod.GET)
    public String accessDenied() {
        return "congan/accessDenied";
    }
