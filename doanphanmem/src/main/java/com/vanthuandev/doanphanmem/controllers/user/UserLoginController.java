...
@Controller
@RequestMapping("/nguoidung-panel")
public class UserLoginController {

    @RequestMapping(method = RequestMethod.GET)
    public String index() {
        return "redirect:/nguoidung-panel/login";
    }
            ...
            ModelMap modelMap)
    {
        ...
        modelMap.put("formLogin", "Người Dùng Login");
    ...
    public String logout(HttpSession httpSession) {
        ...
        return "redirect:/nguoidung-panel/login?logout";
    }

    @RequestMapping(value = "accessDenied", method = RequestMethod.GET)
    public String accessDenied() {
        return "nguoidung/accessDenied";
    }
